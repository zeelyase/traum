...
function get_active_product_number(){

    $t = &get_instance();
    $t->load->model("product_model");

    $number = $t->product_model->get_all_number(
        array(
            "isActive" => 1
        )
    );
...
function get_completed_product_number(){
...
function get_product_images_number(){

    $t = &get_instance();
    $t->load->model("product_image_model");

    $number = $t->product_image_model->get_all_number(
        array(
            "isActive" => 1
        )
    );
...
function get_users_number(){
    ...
    $number = $t->user_model->get_all_number(
        array(
            "isActive" => 1
        )
    );
