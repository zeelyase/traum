...
<!--                        ürünler alanını proje olarak çevirdim-->
                    </a>
                </li>
...
<!--                </li>-->
                ...
                <li>
                    <a href="<?php echo base_url("newservices"); ?>">
                        <i class="menu-icon fa fa-cutlery"></i>
                        <span class="menu-text">Hizmetlerimiz</span>
<!--                        Bu alan bi üstteki hizmetlerimizden biraz farklı. zaten newservices şekline yaptım bunu.-->
                    </a>
                </li>
...
<!--                </li>-->
                ...
                <li>
                    <a href="http://www.traum.com.tr" target="_blank">
